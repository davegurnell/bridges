...
object SampleTypes {
  ...
  // Sample coproduct
  sealed abstract class OneOrOther extends Product, Serializable
  case class One(value: String)    extends OneOrOther
  case class Other(value: Int)     extends OneOrOther

  // Coproduct with Object
  sealed trait ClassOrObject     extends Product, Serializable
  ...
  sealed abstract class NestedClassOrObject extends Product, Serializable
  ...
  sealed abstract class Shape                                             extends Product, Serializable
  ...
  val customDeclaration: TsDecl = {
    import bridges.syntax._
    decl("Message")(union(
      labelled("ErrorMessage")(struct("error" ---> ref("ErrorMessage"))),
      labelled("WarningMessage")(struct("warning" ---> ref("WarningMessage"))),
    ))
  }
